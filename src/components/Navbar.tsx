    ...
    <nav className="sticky top-0 z-50 bg-bright-snow-50/90 backdrop-blur-md border-b border-white-200">
      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 font-medium text-white-700">
          <a href="#" className="hover:text-raw-umber-600 transition">
            Beranda
          </a>
          <a href="#" className="hover:text-raw-umber-600 transition">
            Menu Kami
        ...
        <div className="flex items-center gap-4">
          <button className="relative p-2 cursor-pointer text-white-800 hover:text-raw-umber-600 transition">
            <ShoppingBag size={24} />
            <span className="absolute top-0 right-0 bg-raw-umber-500 text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center">2</span>
          </button>
